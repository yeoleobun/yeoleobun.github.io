---
title: "REUSEPORT"
date: 2024-03-10T15:42:19+08:00
draft: false
---

我一直以为开启`SO_REUSEPORT`之后，只有第一个绑定的`socket`可以`accept`到新的连接。最近看`gen_tcp`文档，其中有一个选项是`reuseport_lb`，显然这个选项说明新的连接可以负载均衡到绑定到同一个端口的各个socket。
